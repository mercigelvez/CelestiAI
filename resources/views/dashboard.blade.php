...
<div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative z-10 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div class="bg-black bg-opacity-30 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-purple-800 hover:border-purple-600 transition-all">
        ...
        <!-- Reading options -->
        <h2 class="text-2xl font-['Cormorant_Garamond'] font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-indigo-400 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-black bg-opacity-30 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-purple-800 hover:border-purple-600 transition-all">
                ...
                <p class="text-gray-300 mb-6 text-center">A comprehensive 10-card spread that explores your situation in depth.</p>
                <a href="{{ route('readings.create', ['spread' => 'celtic-cross']) }}" class="block w-full py-2 text-center rounded-lg bg-purple-900 bg-opacity-50 text-white hover:bg-opacity-70 transition-all">
                    Select
                </a>
            </div>
            ...
            <div class="bg-black bg-opacity-30 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-purple-800 hover:border-purple-600 transition-all">
                ...
                <p class="text-gray-300 mb-6 text-center">Explore the energies, challenges and potential of a relationship.</p>
                <a href="{{ route('readings.create', ['spread' => 'relationship']) }}" class="block w-full py-2 text-center rounded-lg bg-purple-900 bg-opacity-50 text-white hover:bg-opacity-70 transition-all">
                    Select
                </a>
            </div>
            ...
            <div class="bg-black bg-opacity-30 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-purple-800 hover:border-purple-600 transition-all">
                ...
                <p class="text-gray-300 mb-6 text-center">Illuminate your professional journey and discover opportunities ahead.</p>
                <a href="{{ route('readings.create', ['spread' => 'career']) }}" class="block w-full py-2 text-center rounded-lg bg-purple-900 bg-opacity-50 text-white hover:bg-opacity-70 transition-all">
                    Select
                </a>
            </div>
        </div>
        ...
        <div class="mt-12 bg-black bg-opacity-30 backdrop-filter backdrop-blur-sm rounded-xl p-8 border border-purple-800">
            <h2 class="text-2xl font-['Cormorant_Garamond'] font-bold text-purple-300 mb-4">Custom Reading</h2>
            <p class="text-purple-200 mb-6">Ask a specific question and choose your preferred spread for personalized guidance.</p>

            <a href="{{ route('readings.create') }}" class="inline-block px-6 py-3 rounded-lg bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-medium hover:from-purple-600 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl">
        ...
        <div class="mt-12">
            <h2 class="text-2xl font-['Cormorant_Garamond'] font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-indigo-400 mb-6">
            ...
            <div class="bg-black bg-opacity-30 backdrop-filter backdrop-blur-sm rounded-xl overflow-hidden">
                ...
                <div class="px-6 py-4 border-t border-purple-800">
                    <a href="{{ route('readings.history') }}" class="text-indigo-400 hover:text-indigo-300 flex items-center justify-center">
                        View All Readings
